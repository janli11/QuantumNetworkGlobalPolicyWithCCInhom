...
python DataGen/RLTrainSimIndHpc.py -idx $SLURM_ARRAY_TASK_ID -N_idx $N_idx -train 0 -train_more 0 -train_steps "1e7" -sim 1 -sim_eps "5e3" -train_new_model 1 -training_version_start "0" -training_version_stop "20"
