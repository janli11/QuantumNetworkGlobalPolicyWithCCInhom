...
python DataGen/RLTrainSimHpc.py -idx $SLURM_ARRAY_TASK_ID -N_idx $N_idx -train 1 -train_more 0 -train_steps "1e7" -sim 0 -sim_eps "1e3" -train_new_model 1 -training_version_start "5" -training_version_stop "10"